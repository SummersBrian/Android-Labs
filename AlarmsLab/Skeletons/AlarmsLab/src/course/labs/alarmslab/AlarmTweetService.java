...
public class AlarmTweetService extends IntentService {
	...
	private static final String MY_TWEET_TAG = " #Plunder";
	...
	// Consumer Key
	private final static String CONSUMER_KEY = "qUkfkuK8xKhxGq3BztWlLw";

	// Consumer Secret

	private final static String CONSUMER_SECRET = "cck2aY4390u8Z9hFRfE7TSRYrATUQG0MkB61xEErDg";

	// Access Token
	private static String ACCESS_TOKEN = "2151782420-mHjtmHTQiE4L6nDgIhMbzfDYtjE6JFNK2Bm04nq";

	// Access Token Secret
	private static String ACCESS_TOKEN_SECRET = "Wy9SK20WbZnDjXlxBH1gxQRKNCz9Pi4EoMCyJPGrjjJVY";
	...
	public class NetworkingTask extends AsyncTask<String, Void, Boolean> {
		...
		protected Boolean doInBackground(String... params) {
			try {
				return postTweet(params[0] + MY_TWEET_TAG);
			} catch (IOException e) {
				e.printStackTrace();
				return false;
			}
		...
		protected void onPostExecute(Boolean result) {
			...
			Toast tweetSuccessToast = Toast.makeText(getApplicationContext(),"The Tweet was submitted with result:" + result, Toast.LENGTH_LONG);
			tweetSuccessToast.show();
		}
	}
